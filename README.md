...
```typescript
presentPaymentFlow() => Promise<{ cardNumber: string; error?: string; debugError?: string; }>
```

**Returns:** <code>Promise&lt;{ cardNumber: string; error?: string; debugError?: string; }&gt;</code>
...
| **`address`**                    | <code><a href="#ibillingaddress">IBillingAddress</a></code> |                                                                                                  |                         |
...
| **`lineOne`**     | <code>string</code> |
| **`lineTwo`**     | <code>string</code> |
